...
REM The PATH must include a folder that contains the RTI standard RTI1516e assemblies, for example
REM pRTI: C:\Program Files\prti1516e\lib\vc141_64;C:\Program Files\prti1516e\lib;C:\Program Files\prti1516e\jre\bin\server;
REM MAK RTI: C:\MAK\makRti4.6.1\bin
REM The first folder containing the assemblies is the one that is used unless overriden in this script
REM use "set PATH=<desired RTI folder(s);%PATH%
