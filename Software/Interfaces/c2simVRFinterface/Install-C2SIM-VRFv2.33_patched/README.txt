...
VERSION 2.32 uses C++ClientLibv4.8.3.1 with libboost-*-vc140-*
...
The top-level directory c2simVRFinterfacev2.32 can be installed in C:\
or elsewhere. 

v2.32 includes binaries for C++C2SIMClientLibv4.8.3.1, which is 
...
v2.32 is compatible with C2SIM CWIX2023v1.0.2. It accepts multiple
...
c2simVRFv2.32 accepts a ninth command line parameter that
...
c2simVRFv2.32 uses these command line parameters;
...
Version 2.32 includes support for batching multiple <ReportContent>
